            ...
            <Row align="center" className="w-full">
              <Column className="w-full max-w-xl mx-auto">
                ...
                <Section className="p-4">
                  ...
                  <Text className="text-center text-lg mb-4">
                    If you didn't ask to reset your password for the Eversweet
                    App, you can safely ignore this email.
                  </Text>
                </Section>
                ...
                <Section className="p-4 bg-gray-100 mt-4 rounded-lg">
                  ...
                  <Text className="text-center text-sm text-gray-600 mb-2">
                    ...
                    <Link href="https://www.instagram.com/eversweet.dessert/">
                      Instagram
                    </Link>
                  </Text>

                  <Text className="text-center text-sm text-gray-600 mb-2">
                    You are receiving this email because you asked to reset your
                    password for the Eversweet App.
                  </Text>
                </Section>
              </Column>
            </Row>
