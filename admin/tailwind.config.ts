  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "sans-light": ["Inter-Light", "Helvetica", "Arial", "sans-serif"],
        "sans-medium": ["Inter-Medium", "Helvetica", "Arial", "sans-serif"],
        "sans-semibold": ["Inter-SemiBold", "Helvetica", "Arial", "sans-serif"],
        "sans-bold": ["Inter-Bold", "Helvetica", "Arial", "sans-serif"],
      },
    },
  },
  plugins: [],
